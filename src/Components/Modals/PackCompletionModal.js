import { Box, Button, Card, CardContent, Container, Grid, Modal, Stack, TextField, Tooltip, Typography } from "@mui/material";
                                            ...
                                            <Stack direction='column' spacing={1}>
                                                {
                                                    props.data?.beatmaps.map((beatmap, index) => {
                                                        ...
                                                        return (
                                                            <LeaderboardItem
                                                                background={`https://assets.ppy.sh/beatmaps/${beatmap?.beatmapset_id}/covers/cover.jpg`}
                                                                onClick={() => {
