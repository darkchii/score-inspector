            ...
            <Box>
                <Alert severity="info" sx={{ mb: 2 }}>
                    <Typography variant="body1">
                        Results are limited to 1000 scores. Scores may be missing due to not being registered or score over pp situations. It can take a while to get the data.
                    </Typography>
                </Alert>
                {
                    isWorking ? <Loader /> : (
                        <>
                            ...
                            <Box sx={{ pb: 1, pt: 2, display: 'flex', height: 600 }}>
                                <AutoSizer>
                                    {({ height, width }) => (
                                        <VTable
                                            width={width}
                                        ...
                                        >
                                            ...
                                            <Column label="Date" dataKey="date_played" cellRenderer={({ rowData }) => <Tooltip title={rowData.date_played}> {moment(rowData.date_played).fromNow()} </Tooltip>} width={150} />
                                        </VTable>
                                    )}
                                </AutoSizer>
                            </Box>
