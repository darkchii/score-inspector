...
const updates = [
    {
        ...
        changes: [
            ...
            [CHANGETYPES.NEW, 'Added 2014 pp with star ratings from the time', '775f5aa4d93b6e1b2c0dabb4fe17d58be2ded0e3'],
            [CHANGETYPES.NEW, 'Added 2016 star rating values (DT is still a bit buggy)', '00162a640da078cc5a072596649eb7f0f768c048'],
            [CHANGETYPES.FIX, 'Fixed PP objects getting assigned incorrectly', 'c6529e7c6cacff978cbbfa8cda575d8c26d56ab2'],
            ...
            [CHANGETYPES.FIX, 'Fixed unique rank leaderboards'],
