...
const updates = [
    {
        ...
        changes: [
            ...
            [CHANGETYPES.NEW, 'Added average score per play to monthly graphs'],
            [CHANGETYPES.NEW, 'Added length data to monthly graphs'],
            [CHANGETYPES.NEW, 'Added highest pp play to monthly graphs'],
